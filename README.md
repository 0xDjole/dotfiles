...
- Take <code>i3config</code> from repo and put it <code>**HOME**/.config/i3/config</code> file. Also download **arch.png** from repo if you want to use it as a background. I put my in <code>~/Documents</code>, so be sure to tweak i3 config file if your image will be in a different path. 
